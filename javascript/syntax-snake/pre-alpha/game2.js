...
const targetWords = ["I", "you","he", "she", "we", "us", "they","him", "her", "the", "a", "on","under", "off", "out", "in", "an","up", "down"];
const distractorWords = ["apple", "run", "happy", "dog", "jump","shear", "sheer", "ale", "thunder", "pout","pin","sin", "ran", "pup","isle","heap","sheep", "shea", "use","ran","cold", "big","fun","crown","gown","clown","cup","tea","hear"];
let words = [];
let score = 0;
