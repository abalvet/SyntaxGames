...
const targetWords = ["je","tu", "il", "elle","on", "nous", "vous", "ils","elles","le","la","les","lui","leur","me","te","se","sur","sous","avec","contre","dans","en","un","une","des","ma","ta","sa","et","ou","qui","que","quoi","quand","si","mais","où","entre"];
const distractorWords = ["luire","mets","houe","heure","sûr", "saoul","centre","dent","an","lune","dés","tas","sas","mas","mât","est","quille","queue","coi","Caen","scie","houx","centre","sou","antre"];
let words = [];
let score = 0;
